...
import { Menu, X, Scissors, Instagram, Facebook, Twitter, Phone, MapPin, ArrowUp } from 'lucide-react';
...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans selection:bg-gold-500 selection:text-navy-950">
      ...
      >
        <span className="absolute right-full mr-3 bg-white text-navy-950 px-2 py-1 rounded text-xs font-bold opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-md pointer-events-none">
          Chat with us
        </span>
